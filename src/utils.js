...
const getRadialGradient = (ctx,startX,startY,startRadius,endX,endY,endRadius,colorStops) => {
  let lg = ctx.createRadialGradient(startX,startY,startRadius,endX,endY,endRadius);
  for(let stop of colorStops){
    lg.addColorStop(stop.percent,stop.color);
  }
  return lg;
